...
# ----------------------------------------------------------------------------
'''
"install" plugin for ryse command line tool
'''
...
class CCPluginDeploy(ryse.CCPlugin):
    ...
    def find_xap_deploy_tool(self):
        ...
        for reg_flag in reg_flag_list:
            ryse.Logging.info(MultiLanguage.get_string('DEPLOY_INFO_FIND_XAP_FMT',
    ...
    def deploy_android(self, dependencies):
        ...
        ryse.Logging.info(MultiLanguage.get_string('DEPLOY_INFO_INSTALLING_APK'))
        ...
        if not self._no_uninstall:
            ...
            if ryse.app_is_installed(adb_path, self.package):
    ...
    def run(self, argv, dependencies):
        ...
        ryse.Logging.info(MultiLanguage.get_string('DEPLOY_INFO_MODE_FMT', self._mode))

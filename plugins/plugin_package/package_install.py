...
class PackageInstall(ryse.CCPlugin):
    @staticmethod
    def plugin_name():
        return "install"
    ...
    def parse_args(self, argv):
        ...
        parser = ArgumentParser(prog="ryse package %s" % self.__class__.plugin_name(),
    ...
    def run(self, argv):
        ...
        if package_data is None:
            ...
            raise ryse.CCPluginError(message, ryse.CCPluginError.ERROR_OTHERS)

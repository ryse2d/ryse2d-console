...
from ryse import CCPluginError
from ryse import Logging
from argparse import ArgumentParser

class LibsCompiler(ryse.CCPlugin):
    ...
    def compile_win(self):
        ...
        ryse2d_proj_file = os.path.join(self.repo_x, 'ryse/2d/libryse2d.vcxproj')
    ...
    def compile_mac_ios(self):
        ...
        ryse_cmd = self._get_ryse_cmd_path()
    ...
    def compile_android(self):
        ...
        cmd_path = self._get_ryse_cmd_path()
        ...
        for app_abi_item in self.app_abi_list:
            ...
            ryse.copy_files_with_config(copy_cfg, obj_dir, android_out_dir)
    ...
    def _get_ryse_cmd_path(self):
        CONSOLE_PATH = "tools/ryse2d-console/bin"

        engine_dir = self.repo_x
        console_dir = os.path.join(engine_dir, CONSOLE_PATH)
        if ryse.os_is_win32():
            cmd_path = os.path.join(console_dir, "ryse.bat")
        else:
            cmd_path = os.path.join(console_dir, "ryse")

...
# ----------------------------------------------------------------------------
'''
"clean" plugin for ryse2d command line tool
'''
...
class CCPluginClean(ryse2d.CCPlugin):
    """
    cleans a project
    """
    ...
    def clean_android(self):
        ...
        ryse2d.Logging.info("cleaning native")
        obj_path = os.path.join(project_dir, 'obj')
        self._rmdir(obj_path)
        ryse2d.Logging.info("cleaning java")
    ...
    def clean_ios(self):
        ...
        ryse2d.Logging.info("removing intermediate files")
    ...
    def _rmdir(self, path):
        if os.path.exists(path):
            try:
                ...
                raise ryse2d.CCPluginError("Error removing directory: " + str(e.args))

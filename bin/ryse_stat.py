#!/usr/bin/python
# ----------------------------------------------------------------------------
# statistics: Statistics the user behaviors of ryse2d-console by google analytics
#
# Author: Bin Zhang
#
# License: MIT
# ----------------------------------------------------------------------------
'''
Statistics the user behaviors of ryse2d-console by google analytics
'''
...
local_cfg_path = os.path.expanduser('~/.ryse')

#!/usr/bin/python
# ----------------------------------------------------------------------------
# build_console: Build ryse2d-console into executable binary file with PyInstaller
#
# Author: Bin Zhang
#
# License: MIT
# ----------------------------------------------------------------------------
'''
Build ryse2d-console into executable binary file with PyInstaller
'''
...
class Builder(object):
    ...
    def do_build(self):
        ...
        _cp.optionxform = str
        _cp.read(os.path.join(self.src_path, "bin/ryse2d.ini"))
...
if __name__ == "__main__":
    parser = ArgumentParser(description="Generate executable file for ryse2d-console by PyInstaller.")
    parser.add_argument('-s', '--src-path', dest='src_path', help='Specify the path of ryse2d-console.')
